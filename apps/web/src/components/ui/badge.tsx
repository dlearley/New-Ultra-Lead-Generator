  ...
  "inline-flex items-center rounded-full border px-3 py-0.5 text-xs font-medium",
  {
    variants: {
      variant: {
        ...
        ghost: "border-transparent bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300",
      },
    },
    defaultVariants: {
      variant: "default",
...
export interface BadgeProps
  ...
  variant?: "default" | "secondary" | "outline" | "success" | "warning" | "info" | "destructive" | "ghost" | null;
}
